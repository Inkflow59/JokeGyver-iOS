...
-(id)initWithRunData:(CRunGameCenterAchievements*)r andIndex:(int)i
{
    if(self = [super init])
    {
        ...
        CGSize size = [title sizeWithFSFont:[titleFont createFont] constrainedToSize:CGSizeMake(1000, 100000) lineBreakMode:(NSLineBreakMode)0];
        int sxText = (int)size.width;
        syText = (int)size.height;
        size = [string sizeWithFSFont:[textFont createFont] constrainedToSize:CGSizeMake(1000, 100000) lineBreakMode:(NSLineBreakMode)0];
