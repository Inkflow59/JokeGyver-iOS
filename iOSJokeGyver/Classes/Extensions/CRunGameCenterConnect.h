...
@interface CESGameCenter : CExtStorage <GKLocalPlayerListener, GKMatchmakerViewControllerDelegate, GKMatchDelegate>
{
@public
...
-(void)findNames:(NSArray<GKPlayer*>*)players;
-(void)addPlayers;
-(int)getNPlayers;
