...
short b2mHandleRunObject(LPRDATAM rdPtr)
{
	if (!b2mrStartObject(rdPtr) || rdPtr->base->bPaused)
		return 0;
...
{
    m_object = calloc(sizeof(RUNDATAM), 1);
...
-(void)action:(int)num withActExtension:(CActExtension*)act
{
    ...
    switch (num)
    {
        ...
        case b2mACT_SETANGLE:
            b2mRACT_SETANGLE(rdPtr, act->pParams[0]->evp.evpL.evpL0, 0);
            break;
        ...
        case b2mACT_SETHEIGHT:
            ...
            break;
        case b2mACT_ONOFF:
            b2mRACT_ONOFF(rdPtr, [act getParamExpression:rh withNum:0], 0);
            break;
    }
}
