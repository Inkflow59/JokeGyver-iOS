...
-(BOOL)createRunObject:(CFile*)file withCOB:(CCreateObjectInfo*)cob andVersion:(int)version
{
	...
	textField.autocorrectionType = (UITextAutocorrectionType)correction;	// no auto correction support
	textField.keyboardType = (UIKeyboardType)keyboard;	// use the default type input method (entire keyboard)
	textField.returnKeyType = (UIReturnKeyType)ret;
	textField.clearButtonMode = (UITextFieldViewMode)clear;	// has a clear 'x' button to the right
	textField.text=text;
	textField.textAlignment = (NSTextAlignment)align;
...
-(void)action:(int)num withActExtension:(CActExtension*)act
{
	...
	{        
        ...
        case ACT_TFSHOW:
        {
            BOOL sel = textField.selected;
            textField.selected=YES;
            if([textField isHidden])
                [textField setHidden:NO];
            textField.selected=sel;
            break;
        }
        case ACT_TFHIDE:
        {
