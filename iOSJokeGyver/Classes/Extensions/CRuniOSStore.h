...
-(void)addStoreListener:(CRuniOSStore*_Nonnull)store;
-(void)removeStoreListener:(CRuniOSStore*_Nonnull)store;
-(void)releasePending;
-(void)startProductRequest:(SKProductsRequest*_Nonnull)request;
-(void)sendEvents;
@end
...
-(BOOL)shouldAddStore:(nonnull NSString *)productId;
