...
- (id)initWithWidth:(int)w andHeight:(int)h andRenderer:(CRenderer*)render andSwapMode:(bool)bSwap andPOTMode:(bool)potMode
{
    handle = -1;
...
{
   return [self initWithWidth:w andHeight:h andRunApp:runApp andSwapMode:YES andPOTMode:NO];
}

- (id)initWithWidth:(int)w andHeight:(int)h andRunApp:(CRunApp*)runApp andSwapMode:(bool)bSwap
{
    return [self initWithWidth:w andHeight:h andRunApp:runApp andSwapMode:bSwap andPOTMode:NO];
}

- (id)initWithWidth:(int)w andHeight:(int)h andRunApp:(CRunApp*)runApp andPOTMode:(bool)potMode
{
    return [self initWithWidth:w andHeight:h andRunApp:runApp andSwapMode:YES andPOTMode:potMode];
}

- (id)initWithWidth:(int)w andHeight:(int)h andRenderer:(CRenderer*)renderer
{
   return [self initWithWidth:w andHeight:h andRenderer:renderer andSwapMode:YES andPOTMode:NO];
}

- (id)initWithWidth:(int)w andHeight:(int)h andRenderer:(CRenderer*)renderer andSwapMode:(bool)bSwap
{
    return [self initWithWidth:w andHeight:h andRenderer:renderer andSwapMode:bSwap andPOTMode:NO];
}

- (id)initWithWidth:(int)w andHeight:(int)h andRenderer:(CRenderer*)renderer andPOTMode:(bool)potMode
{
    return [self initWithWidth:w andHeight:h andRenderer:renderer andSwapMode:YES andPOTMode:potMode];
}
...
-(void)bindFrameBufferWithOffset:(Vec2f)offset
{
    ...
    renderer->currentRenderState.contentSize = Vec2f(width, height);
    renderer->setProjectionMatrix(0, 0, width, height);
    renderer->currentRenderState.transform = Mat3f::translationMatrix(offset.x, offset.y);
    renderer->forgetCachedState();
}
...
-(void) fillWithPixels:(unsigned int*)buffer withWidth:(int)w andHeight:(int)h
{
    ...
    else
    {
        ...
        texData = (unsigned int*)calloc(pixels, sizeof(char)*bytesPrPixel);
