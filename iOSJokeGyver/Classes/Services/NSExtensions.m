...
- (CGSize) sizeWithFSFont:(UIFont *)fontToUse
{
...
- (CGSize) sizeWithFSFont:(UIFont *)fontToUse constrainedToSize:(CGSize)size lineBreakMode:(NSLineBreakMode)flag
{
    if ([self respondsToSelector:@selector(sizeWithAttributes:)])
    {
        NSDictionary* attribs = @{NSFontAttributeName:fontToUse,
    ...
    return ([self sizeWithFont:fontToUse constrainedToSize:size lineBreakMode:flag]);
}
