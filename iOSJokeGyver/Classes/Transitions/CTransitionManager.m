...
-(CTrans*)startObjectFade:(CObject*)hoPtr withFlag:(BOOL)bFadeOut
{
	...
	if(sprite == nil)
	{
        ...
        sprite->sprImgNew = hoPtr->roc->rcImage;
        sprite->sprX = hoPtr->hoX;
        sprite->sprY = hoPtr->hoY;
        sprite->sprX1 = sprite->sprX1new = hoPtr->hoX - hoPtr->hoImgXSpot;
        sprite->sprY1 = sprite->sprY1new = hoPtr->hoY - hoPtr->hoImgYSpot;
        sprite->sprX2 = sprite->sprX2new = hoPtr->hoX + hoPtr->hoImgWidth;
        sprite->sprY2 = sprite->sprY2new = hoPtr->hoY + hoPtr->hoImgHeight;
	}
	else
	{
        [sprite retain];
