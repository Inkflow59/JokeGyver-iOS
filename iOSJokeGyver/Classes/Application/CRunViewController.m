...
-(void)loadView
{
    ...
    runView.autoresizesSubviews = UIViewAutoresizingNone;
    ...
    //
    //    Uncomment the following lines to check iOS font names
    //    when using external fonts. Keyshortcut -> Cmd /
    //
//    NSArray* fNames=[UIFont familyNames];
//    for (int n=0; n<[fNames count]; n++)
//    {
//        NSString* fName=[fNames objectAtIndex:n];
//        NSArray* ffNames=[UIFont fontNamesForFamilyName:fName];
//        NSLog(@"family font: %@ => %@", fName, ffNames);
//    }
