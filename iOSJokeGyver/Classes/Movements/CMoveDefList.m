...
-(void)load:(CFile*)file 
{
	...
	for (n=0; n<nMovements; n++)
	{
		...
		if (type==14)       // MVTYPE_EXT
		{
			...
			CMoveDefExtension* mvPtr = (CMoveDefExtension*)moveList[n];
			[mvPtr setModuleName:[name substringToIndex:[name length]-4] withID:mvtID];
			[name release];
			...
			{
				mvPtr->mvRuntimeFlags|=MVRTFLAG_PHYSICS;
			}
