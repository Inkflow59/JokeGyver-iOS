...
void CRunBox2DBackground::CreateFixture(LPHO pHo)
{
	...
	switch(m_shape)
	{
        case 0:
            ...
            break;
        case 1:
            m_fixture=m_base->pBodyCreateCircleFixture(m_base, m_mBase->m_body, m_mBase, m_pHo->hoX, m_pHo->hoY, (int)((m_imgWidth + m_imgHeight + 2)/4 * (m_scaleX + m_scaleY) / 2), 0, m_friction, m_restitution);
            break;
        case 2:
