		...
		case 4:	    // CTA_ANIM:
			if (vInt != 0)
			{
				...
				for (y = y1; y < y2 && vInt > 0; y += ifo->height)
				{
					...
					{
						[hoAdRunHeader->spriteGen pasteSpriteEffect:renderer withImage:adCta->frames[0] andX:x andY:y andFlags:0 andInkEffect:effect andInkEffectParam:effectParam andEffectShader:effectShader];
					}
				}
			}
			break;
